...
class CentroidObject(object):
    # TODO: _borders has unnessecary many entries: e.g. _borders[3] also has information about 0,1 & 2!
...
class Centroids(object):
    ...
    def __init__(self, comp_obj: 'comparison.Comparison') -> 'Centroids':
        """
        Short description and reference to Centroids algorithm

        :param comp_obj: comparison.Comparison
        """
